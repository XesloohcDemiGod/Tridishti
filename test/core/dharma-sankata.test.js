...
const dharma_sankata_1 = require("../../src/core/dharma-sankata");
describe('DharmaSankata', () => {
    ...
    beforeEach(() => {
        ...
        dharmaSankata = new dharma_sankata_1.DharmaSankata(config, eventEmitter);
    });
    afterEach(() => {
        dharmaSankata.stop();
        jest.clearAllMocks();
    ...
    describe('scope checking', () => {
        ...
        it('should detect file threshold violation', async () => {
            // Mock files changed
            const mockVSCode = global.testUtils.mockVSCode;
...
//# sourceMappingURL=dharma-sankata.test.js.map