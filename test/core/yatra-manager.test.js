...
const yatra_manager_1 = require("../../src/core/yatra-manager");
describe('YatraManager', () => {
    ...
    beforeEach(() => {
        ...
        stateStorage = global.testUtils.createMockMemento();
        yatraManager = new yatra_manager_1.YatraManager(config, eventEmitter, sutraCheckpoints, karmaPhala, dharmaSankata, stateStorage);
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    ...
    describe('state persistence', () => {
        ...
        it('should restore state on initialization', async () => {
            ...
            const newYatraManager = new yatra_manager_1.YatraManager(config, eventEmitter, sutraCheckpoints, karmaPhala, dharmaSankata, stateStorage);
        ...
        it('should skip state restoration when disabled', async () => {
            ...
            const newYatraManager = new yatra_manager_1.YatraManager(disabledConfig, eventEmitter, sutraCheckpoints, karmaPhala, dharmaSankata, stateStorage);
            await newYatraManager.restoreState();
    ...
    describe('sankalpa reminders', () => {
        ...
        it('should start sankalpa reminders when configured', async () => {
            ...
            const newYatraManager = new yatra_manager_1.YatraManager(reminderConfig, eventEmitter, sutraCheckpoints, karmaPhala, dharmaSankata, stateStorage);
...
//# sourceMappingURL=yatra-manager.test.js.map