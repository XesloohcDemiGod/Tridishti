...
const drishti_dashboard_1 = require("../../src/analytics/drishti-dashboard");
describe('DrishtiDashboard', () => {
    let config;
    let drishtiDashboard;
    beforeEach(() => {
        config = {
            enabled: true,
            maxEvents: 1000,
        ...
        drishtiDashboard = new drishti_dashboard_1.DrishtiDashboard(config);
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    describe('event recording', () => {
        ...
        it('should maintain event limit', () => {
            ...
            const limitedDashboard = new drishti_dashboard_1.DrishtiDashboard(limitedConfig);
    ...
    describe('metrics calculation', () => {
        ...
        it('should handle empty dashboard', () => {
            const emptyDashboard = new drishti_dashboard_1.DrishtiDashboard(config);
...
//# sourceMappingURL=drishti-dashboard.test.js.map